...
/** 
* llcm.h
* The enumeration is used for quick selection of PLL P argument
...
/** 
* llcm.h
* The enumeration is used for quick selection of APB1/APB2 divider
...
/** 
* llcm.h
* The enumeration is used for quick selection of AHB divider
...
* void initSW(void);
* @endcode
* The function is used for quick pins setup to select Serial Wire debug.
...
* @endcode
* The function is used to set up SystemCoreClock speed.
...
* @param APB1 the value specifies the bus clock speed division for APB1 bus. #APB_divider may be used to quickly select divider
* @param APB2 the value speicifies the bus clock speed division for APB2 bus #APB_divider may be used to quickly select divider
*/
void init_clock_HSE(uint32_t M_arg, uint32_t N_arg, ePLLP_arg P_arg, AHB_divider AHB, APB_divider APB1,
                    APB_divider APB2); /*initialise System clock to work at 100 MHz*/
...
* @endcode
* The function is used to initialise SysTick.
* Example usage:
* @code{C}
* int main(void){
*  init_clock_HSE(25, 200, pllp_div2, AHB_div1, APB_div2, APB_div1); // initialise clock to work at 100 MHz (HSE = 25 MHz)
*  init_SysTick(1000); // initialise SysTick to work in milliseconds
*  while(1){}
*  return 0;
* }
* @endcode
...
*/
void init_SysTick(uint32_t ticks);     /* initialise SysTick to work at 1ms */
...
* @warning The SysTick must be initialised before usage.
